                    ...
                    <fieldset class="border p-4 shadow-sm rounded mb-4" style="border:2px #c9c9c9 dotted !important;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" name="nid_or_passport" class="form-control" placeholder="Enter Nid Or Passport" required>
                            </div>
                            <div class="col-lg-6 mb-3">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input name="permanent_address" class="form-control" placeholder="Enter Permanent Address">
                            </div>
                            <div class="col-lg-6 mb-3">
