...
@section('content')
      ...
      <div class="br-section-wrapper">
            <h6 class="br-section-label text-center">All Child Category</h6>
                    ...
                    @foreach ($child_category as $item)
                      <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-primary btn-sm mr-3" href="{{route('admin.childcategory.edit', $item->id)}}"><i class="fa fa-edit"></i></a>
                        ...
                        <div id="deleteModal{{$item->id}}" class="modal fade">
                                <div class="modal-dialog modal-dialog-top" role="document">
                                    ...
                                    <div class="modal-body tx-center pd-y-20 pd-x-20">
                                        <form action="{{route('admin.childcategory.delete')}}" method="post" enctype="multipart/form-data">
                                            @csrf
    ...
    <div id="addModal" class="modal fade effect-scale">
        <div class="modal-dialog modal-lg modal-dialog-top mt-4" role="document">
            ...
            <div class="modal-header pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Add Child Category</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="col-xl-12">
                    <div class="form-layout form-layout-4">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <select class="form-control " name="child_cat_status">
