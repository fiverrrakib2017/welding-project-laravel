...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <button data-toggle="modal" data-target="#addModal" type="button" class="btn btn-success mb-2">
                        <i class="mdi mdi-account-plus"></i> Add New Slider
                    </button>
    ...
    @include('Backend.Modal.Settings.Website.Slider.slider_modal')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $("#datatable1").DataTable({
                ...
                beforeSend: function() {},
                complete: function() {},
                ajax: "{{ route('admin.settings.website.slider.get_all_data') }}",
                language: {
        ...
        //     var id = $(this).data('id');
        //     $.ajax({
        //         url: "{{ route('admin.settings.website.slider.edit', ':id') }}".replace(':id', id),
        //         method: 'GET',
        //         success: function(response) {
        //             if (response.success) {
        //                 $('#bannerForm').attr('action', "{{ route('admin.settings.website.slider.update', ':id') }}"
        //                     .replace(':id', id));
        ...
        $('#datatable1 tbody').on('click', '.delete-btn', function () {
            var id = $(this).data('id');
            var deleteUrl = "{{ route('admin.settings.website.slider.delete', ':id') }}".replace(':id', id);
