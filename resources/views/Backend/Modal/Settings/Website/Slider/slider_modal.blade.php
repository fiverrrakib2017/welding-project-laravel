    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content col-md-12">
            <div class="modal-header">
                <h5 class="modal-title" id="bannerModalLabel"><span class="mdi mdi-account-check mdi-18px"></span>
                    &nbsp;Add New Slider</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.settings.website.slider.store') }}" id="bannerForm" method="POST"
